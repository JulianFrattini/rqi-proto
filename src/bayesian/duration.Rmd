...
The model using the skewed normal distribution outperforms the other model in terms of predictive power according to loo_compare and will be used for evaluation.
