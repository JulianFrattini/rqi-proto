...
Next, we conduct the $3 \times 5 = 15$ hypotheses tests and store the results. 
We have paired data for analyzing both hypotheses, because every participant processed two requirements with different configurations of the independent variable for both configurations of the other independent variable. 
We determine, whether the data is normally distributed via the *Shapiro-Wilk test* and then select either the *paired student t-test* or the *Wilcoxon signed rank test* to evaluate the null-hypothesis.
...
for (outcome in response.variables) {
  for (treatment in treatments) {
    ...
    # depending on the result of the Shapiro-Wilk test for normal distribution, either perform a Wilcoxon signed rank test or a t-test
